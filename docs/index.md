# go-ruby-actionview documentation

**Pure-Go, MRI-4.0.5-faithful Ruby actionview (no cgo)**

`go-ruby-actionview/actionview` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `actionview`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `actionview`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-actionview/actionview
```
...
| Repo | What it is |
| --- | --- |
| [`actionview`](https://github.com/go-ruby-actionview/actionview) | the library — Ruby's `actionview` in pure Go |
| [`docs`](https://github.com/go-ruby-actionview/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-actionview.github.io`](https://github.com/go-ruby-actionview/go-ruby-actionview.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-actionview/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-actionview/actionview](https://github.com/go-ruby-actionview/actionview).
