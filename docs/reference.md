...
The public API lives at the module root (`github.com/go-ruby-actionview/actionview`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `actionview`, while the surface follows
...
```go
import "github.com/go-ruby-actionview/actionview"
```
...
- **[pkg.go.dev/github.com/go-ruby-actionview/actionview](https://pkg.go.dev/github.com/go-ruby-actionview/actionview)**

The module's [README](https://github.com/go-ruby-actionview/actionview#readme) carries worked
